    ...
    <script>
        ...
        function init(){
            const serviceTitleMap = new Map([
                ...
                ['HifuFacial', 'HIFU'],
                ['Microneedling', 'Microneedling + <a href="/harryettesalon/services.php?service=HarryetteFacial" style="color: black;">Harryette' + "'" + 's Facial</a>'],
                ['RFMicroneedling', 'RF Microneedling + <a href="/harryettesalon/services.php?service=HarryetteFacial" style="color: black;">Harryette' + "'" + 's Facial</a>'],
                ['Mesoestetic', 'Mesoestetic Chemical Peeling'],
                ['ChanelTreatment', 'Chanel Treatment'],
                ['CarbonLaser', 'Carbon Laser + <a href="/harryettesalon/services.php?service=HarryetteFacial" style="color: black;">Harryette' + "'" + 's Facial</a>'],
